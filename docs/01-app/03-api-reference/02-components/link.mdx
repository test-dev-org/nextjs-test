...
For [dynamic route segments](/docs/app/api-reference/file-conventions/dynamic-routes), it can be handy to use [template literals and interpolation](https://developer.mozilla.org/docs/Web/JavaScript/Reference/Template_literals) to create the link's path.
